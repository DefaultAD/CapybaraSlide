// DecompilerFi decompiler from Assembly-CSharp.dll class: AndroidPermissionsWrapper
using System;
using UnityEngine;
...
public class AndroidPermissionsWrapper
{
	...
	private bool createJavaObject()
	{
		if (_androidJavaObject == null)
		{
			...
			AndroidJavaObject androidJavaObject = new AndroidJavaObject("com.tabtale.publishingsdk.unity.UnityAndroidPermissionsDelegate");
			if (androidJavaObject == null)
			{
				UnityEngine.Debug.LogError("failed to create delegate java object.");
				return false;
			}
			_androidJavaObject = new AndroidJavaObject("com.tabtale.publishingsdk.core.utils.permissions.AndroidPermissionsWrapper", @static, androidJavaObject);
		}
		if (_androidJavaObject == null)
		{
